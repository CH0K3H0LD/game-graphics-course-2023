...
import {positions, normals, indices} from "../blender/VillageHouse2.js"
...
function draw(timems) {
    ...
    mat4.fromXRotation(rotateXMatrix, time * 0.0000 - Math.PI / 2);
    mat4.fromYRotation(rotateYMatrix, time * 0.0000);
    mat4.mul(modelMatrix, rotateXMatrix, rotateYMatrix);

    mat4.fromXRotation(rotateXMatrix, 1.5);
